...
You can push this really far...for example, you could solve [Pokémon Blue with a single regex statement](https://www.youtube.com/watch?v=Q2g9d29UIzk) [(sort of)](https://github.com/hausdorff/pkmn-mu).
...
<br>
<br>
# `r emo::ji("clipboard")` [Survey](https://docs.google.com/forms/d/e/1FAIpQLSdnK0t8KI_I8pDNQ6WxgnKsW0klxsPL2rbqSgk6SmmogrX52w/viewform)
<br>
<br>
<br>
*If the link above is not working, copy this into your browser.*
```{r, eval=FALSE}
https://docs.google.com/forms/d/e/1FAIpQLSdnK0t8KI_I8pDNQ6WxgnKsW0klxsPL2rbqSgk6SmmogrX52w/viewform
```
]
